...
var options = {
    data: {
        ...
        source: {
            read: {
                url: 'http://localhost:8080/api/allDeleted',
                method: 'GET',
                params: {
                    // custom parameters
                },
    ...
    columns: [
        ...
        },
        {
            ...
            template: function (row, index, datatable) {
                ...
                return '\
                    <a href="http://localhost:8080/admin/view_user/'+ row['id'] +'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View User">\
                        <i class="la la-eye"></i>\
                    </a>\
...
function getId(id){
    ...
    $('#btn-delete').attr('href', function(){
        return 'http://localhost:8080/api/restore_user/'+userId;
    });
};
